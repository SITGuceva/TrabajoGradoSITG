                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="GenerarCer" runat="server" visible="false" class="row">
                                        <asp:Table ID="TBgenerar" runat="server" HorizontalAlign="Center">
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Label ID="Lcertificado" runat="server" Text="Certificado en cuál válida que el proyecto final ha sido aprobado." ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Button ID="Bgenerar" runat="server" Text="Generar" OnClick="GenerarPdf" class="btn btn-success" ForeColor="White" />
                                                </asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
