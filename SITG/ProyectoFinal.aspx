                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="breadcrumb">
                                    <li>
                                        <asp:LinkButton ID="LBSubir_pfinal" runat="server" OnClick="Subir_pfinal" ForeColor="Black"><span class="glyphicon glyphicon-plus"></span>Subir </asp:LinkButton></li>
                                    <li>
                                        <asp:LinkButton ID="LBConsulta_pfinal" runat="server" OnClick="Consulta_pfinal" ForeColor="Black"><span class="glyphicon glyphicon-search"></span>Consulta </asp:LinkButton></li>
                                    <li>
                                        <asp:LinkButton ID="LBGenerar" runat="server" OnClick="Generar_pfinal" ForeColor="Black"><span class="glyphicon glyphicon-search"></span>Generar certificado </asp:LinkButton></li>
                                </ul>
                            </div>
                        </div>
                         ...
                         <div id="GenerarCer" runat="server" visible="false" class="row">
                            ...
                            <asp:Table ID="TBgenerar" runat="server" HorizontalAlign="Center">
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Button ID="Bgenerar" runat="server" Text="Generar certificado" OnClick="GenerarPdf" class="btn btn-default" />
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </div>
