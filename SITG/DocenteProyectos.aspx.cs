...
public partial class DocenteProyectos : System.Web.UI.Page
{
    ...
    protected void btnDummy_Click(object sender, EventArgs e)
    {
        ...
        sql = "insert into PROYECTOS (PROY_ID,PROY_NOMBRE,PROY_DESCRIPCION, PROY_CANTEST, PROY_FECHA, USU_USERNAME, TEM_CODIGO) " +
            "VALUES(proyectoid.nextval, '" + TBnombre.Text.ToLower() + "', '" + TBdescripcion.Value.ToLower() + "', '" + TBcant.Text + "', TO_DATE( '" + fecha + "', 'YYYY-MM-DD HH24:MI:SS'), '" + Session["id"] + "', '" + DDLtema.Items[DDLtema.SelectedIndex].Value.ToString() + "')";
    ...
    private void ResultadoConsulta()
    {
        try{
            ...
            if (conn != null){
                string sql = "select P.Proy_Id,L.Linv_Nombre, T.Tem_Nombre ,P.Proy_Nombre, P.Proy_Descripcion, P.Proy_Cantest,P.Proy_Fecha ,InitCap(P.Proy_Estado) as Estado  from proyectos p, lin_investigacion l, tema t where T.Tem_Codigo = P.Tem_Codigo and T.Linv_Codigo = L.Linv_Codigo and P.Usu_Username = '" + Session["id"]+"'";
    ...
    protected void GVproyectos_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        GVproyectos.Rows[indice].Cells[6].Enabled = false;
    }
