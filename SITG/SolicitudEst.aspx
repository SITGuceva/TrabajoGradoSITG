                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="TipoSolicitud" runat="server" visible="true" class="row">
                                        <asp:Table ID="TSolicitar" runat="server" HorizontalAlign="Center">
                                            ...
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Label ID="Ldescrip" runat="server" Text="Motivo: " ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                                                <asp:TableCell>
                                                    <textarea id="TAdescrip" runat="server" cssclass="form-control"></textarea></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                    ...
                                    <div id="Integrante" runat="server" visible="false" class="row">
                                        <asp:Table ID="Tinteg" runat="server" HorizontalAlign="Center">
                                            <asp:TableRow>
                                                <asp:TableHeaderCell>
                                                    <asp:Label ID="Ltin" runat="server" Text="INTEGRANTE" ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableHeaderCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>
                                            ...
                                            <asp:TableRow ID="RespInte" runat="server" Visible="false">
                                                ...
                                                <asp:TableCell>
                                                    <asp:Button ID="AgregarInt" runat="server" Text="Agregar" OnClick="AgregarInt_Click" class="btn btn-default" /></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    ...
                                    <div>
                                        <asp:Table ID="Tbotones" runat="server" Visible="true" HorizontalAlign="Center">
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Button ID="Bsolicitar" runat="server" Text="Solicitar " OnClick="Bsolicitar_Click" class="btn btn-success" ForeColor="White" /></asp:TableCell>
                                                <asp:TableCell>
