                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="Ingreso" runat="server" visible="true" class="row">
                                        <asp:Table ID="Tgepropuesta" runat="server" HorizontalAlign="center">
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Label ID="LCodigoE" runat="server" Text="Código del Estudiante" ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                                            </asp:TableRow>
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="TBCodigoE" type="number" runat="server" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:Button ID="BTbuscar" runat="server" Text="CONSULTAR" OnClick="Buscar" CssClass="btn btn-default"></asp:Button></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:Button ID="BTnueva" runat="server" Text="NUEVA CONSULTA" OnClick="Nueva" CssClass="btn btn-default" Visible="false"></asp:Button></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
                                    ...
                                    <div id="TablaResultado3" runat="server" visible="false" class="row" style="overflow-x: auto">
                                        <asp:GridView ID="GVproyectofinal" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="APROBACION" HeaderText="Autorización Director" />
                                                <asp:BoundField DataField="JUR1" HeaderText="Jurado 1" />
                                                <asp:BoundField DataField="JUR2" HeaderText="Jurado 2" />
                                                <asp:BoundField DataField="JUR3" HeaderText="Jurado 3" />
                                                <asp:BoundField DataField="ESTADO" HeaderText="Estado" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
