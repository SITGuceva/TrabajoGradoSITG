...
public partial class DocumentosCom : System.Web.UI.Page
{
    ...
    public void CargarProyectoF(int crit)
    {
        ...
        try {
            ...
            if (conn != null) {
                if (crit.Equals(2)){
                      sql = "select P.Ppro_Codigo, P.Pf_Titulo,TO_CHAR( P.Pf_Fecha, 'dd/mm/yyyy') as FECHA ,CONCAT(CONCAT(u.usu_nombre, ' '),u.usu_apellido) as director,  P.Pf_Aprobacion from proyecto_final p, estudiante e, solicitud_dir s, usuario u" +
                    ...
                    sql = "select P.Ppro_Codigo, P.Pf_Titulo,TO_CHAR( P.Pf_Fecha, 'dd/mm/yyyy') as FECHA ,CONCAT(CONCAT(u.usu_nombre, ' '),u.usu_apellido) as director,  P.Pf_Aprobacion from Propuesta n, Tema t, Lin_Profundizacion l, proyecto_final p, estudiante e, solicitud_dir s, usuario u " +
    ...
    public void CargarAnteproyecto(int crit)
    {
        ...
        try {
            ...
            if (conn != null){
                if (crit.Equals(2)){
                   sql = "select A.Apro_Codigo, A.Anp_Nombre,TO_CHAR( A.Anp_Fecha, 'dd/mm/yyyy') as FECHA ,CONCAT(CONCAT(u.usu_nombre, ' '), u.usu_apellido) as director,  A.Ant_Aprobacion, CONCAT(CONCAT(o.usu_nombre, ' '), o.usu_apellido) as revisor from anteproyecto a, estudiante e, solicitud_dir s, usuario u, evaluador r, usuario o " +
