                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                    ...
                                    <asp:GridView ID="GVconsultaAP" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GVconsultaAP_PageIndexChanging" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Evaluador">
                                                <ItemTemplate>
                                                    <asp:Button ID="BTrevisar" runat="server" Text="ASIGNAR" class="btn btn-default" AutoPostBack="true" CommandName="Asignar" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" /></ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                </div>
                                    ...
                                    <asp:GridView ID="GVanteproy" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GVanteproy_PageIndexChanging" AutoGenerateColumns="False" CssClass="table table-bordered bs-table" OnRowDataBound="GVanteproy_RowDataBound" PageSize="6">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Documento">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LinkDescarga" runat="server" Text="Descargar" OnClick="DescargaAnteProyecto" CommandArgument='<%# Eval("APRO_CODIGO") %>'></asp:LinkButton></ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                </div>

                                <div id="Evaluador" runat="server" style="overflow-x: auto" visible="false" class="row">
                                    <asp:Label ID="Levaluador" runat="server" Text="---EVALUADOR ANTEPROYECTO---" ForeColor="Black"></asp:Label>
                                    <asp:GridView ID="GVevaluador" runat="server" AllowPaging="True" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CssClass="table table-bordered bs-table" OnRowDataBound="GVevaluador_RowDataBound" OnRowDeleting="GVevaluador_RowDeleting">
                                        <AlternatingRowStyle BackColor="White" />
                                        <EditRowStyle BackColor="#2461BF" />
                                        <PagerStyle BackColor="#1C2833" ForeColor="White" HorizontalAlign="Center" />
                                        <RowStyle BackColor="white" />
                                        ...
                                        <HeaderStyle BackColor="#1C2833" Font-Bold="True" ForeColor="White" />
                                        <EmptyDataRowStyle ForeColor="Red" CssClass="table table-bordered" />
                                        <EmptyDataTemplate>¡El anteproyecto no tiene evaluador! </EmptyDataTemplate>
                                        <Columns>
                                            <asp:BoundField DataField="EVA_ID" HeaderText="Código" HeaderStyle-HorizontalAlign="Center" />
                                ...
                                <br />
                                <asp:Label ID="Linfo" runat="server" Text="" Font-Bold="True"></asp:Label>
