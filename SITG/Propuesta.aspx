            ...
            <div class="container-fluid">
                ...
                <div id="Ingreso" runat="server" visible="false" class="row">
                    <asp:Table ID="Tsubir" runat="server" HorizontalAlign="Center">   
                        ...
                        <asp:TableRow>
                            <asp:TableCell><asp:Label ID="Lnombre" runat="server" Text="Título:" ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                    ...
                    <asp:GridView  ID="GVagreinte" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" CssClass="table table-bordered bs-table"  PageSize="6">
                     ...
                     <asp:Table ID="TBotones" runat="server" HorizontalAlign="Center">
                        <asp:TableRow>
                            ...
                            <asp:TableCell><asp:Button ID="Bcancelar" runat="server" Text="Cancelar" OnClick="Cancelar" class="btn btn-danger" ForeColor="White"/></asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </div>
                ...
                <div id="Solicitar" runat="server" visible="false" class="row">
                    <asp:Table ID="Ttipodir" runat="server" HorizontalAlign="Center">
                        <asp:TableRow>
                            <asp:TableCell><asp:Label ID="Linterno" runat="server" Text="Interno" ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                            <asp:TableCell><asp:RadioButton ID="RBinterno" runat="server" Text=""  AutoPostBack="true" GroupName="TipoDirector"  OnCheckedChanged="RBtipodirector_CheckedChanged" Checked="True" /></asp:TableCell>
                            <asp:TableCell><asp:Label ID="Lexterno" runat="server" Text="Externo" ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                            <asp:TableCell ><asp:RadioButton ID="RBexterno" runat="server" Text=""  AutoPostBack="true" GroupName="TipoDirector"  OnCheckedChanged="RBtipodirector_CheckedChanged"/></asp:TableCell>
                         </asp:TableRow>
                  ...
                  <asp:Table ID="TSolicitar" runat="server" HorizontalAlign="Center"  >                
                     ...
                     <asp:Table ID="Tcarta" runat="server" Visible="false" HorizontalAlign="Center" >                
                        <asp:TableRow>
                            <asp:TableCell><asp:Label ID="Label1" runat="server" Text="Carta Director:" ForeColor="Black" Font-Bold="True"></asp:Label> </asp:TableCell>
                            <asp:TableCell> <asp:FileUpload ID="FUdirector" runat="server" class="btn btn-default image-preview-input" /></asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                    <asp:Table ID="Tbotones2" runat="server" Visible="false" HorizontalAlign="Center" >                
                         <asp:TableRow HorizontalAlign="Center">
                            <asp:TableCell> <asp:Button ID="Bsolicitar" runat="server"  Text="Solicitar" OnClick="SolicitarDir" class="btn btn-success" ForeColor="White"/></asp:TableCell>
                            <asp:TableCell> <asp:Button ID="Bcancel" runat="server" OnClick="Limpiar" Text="Cancelar" class="btn btn-danger" ForeColor="White" /></asp:TableCell>
                         </asp:TableRow>                           
                    </asp:Table>  
                </div>
