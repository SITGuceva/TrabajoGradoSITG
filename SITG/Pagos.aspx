                    ...
                    <div class="container-fluid">
                        ...
                        <div id="Ingreso" runat="server" visible="false" class="row">
                            ...
                            <asp:Table ID="Tsubir" runat="server" HorizontalAlign="Center">
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Label ID="Ltitulo" runat="server" Text="Título del pago" ForeColor="Black" Font-Bold="True"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>
                                        <asp:TextBox ID="TBtitulo" runat="server" ForeColor="Black" Font-Bold="True" CssClass="form-control"></asp:TextBox>
                                    </asp:TableCell>
                                    <asp:TableCell>
                            ...
                            <asp:Table ID="TableBotones" runat="server" HorizontalAlign="Center">
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Button ID="Bguardar" runat="server" Text="Subir" OnClick="Guardar" class="btn btn-default" />
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </div>
