                    ...
                    <div class="container-fluid">
                        ...
                        <div id="Ingreso" runat="server" visible="false" class="row">
                            ...
                            <asp:Table ID="Tsubir" runat="server" HorizontalAlign="Center">
                                <asp:TableRow>
                                    <asp:TableCell><asp:Label ID="Ltitulo" runat="server" Text="Título:" ForeColor="Black" Font-Bold="True"></asp:Label></asp:TableCell>
                            ...
                            <asp:Table ID="TableBotones" runat="server" HorizontalAlign="Center">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell><asp:Button ID="Blimpiar" runat="server" Text="Cancelar" OnClick="Blimpiar_Click" class="btn btn-danger" ForeColor="White" /> </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </div>
