                            ...
                            <div class="panel-body">
                                    ...
                                    <asp:GridView ID="GVpfasignado" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GVpfasignado_PageIndexChanging" AutoGenerateColumns="False" CssClass="table table-bordered bs-table" OnRowDataBound="GVpfasignado_RowDataBound" PageSize="6" OnRowCommand="GVpfasignado_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Revisar">
                                                <ItemTemplate>
                                                    <asp:Button ID="BTrevisar" runat="server" Text="REVISAR" class="btn btn-default" AutoPostBack="true" CommandName="ProyectoF" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                ...
                                <div id="criterios" runat="server" visible="false" class="row">
                                    ...
                                    <asp:GridView ID="GVcriterios" runat="server" Visible="true" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GVcriterios_PageIndexChanging" AutoGenerateColumns="False" CssClass="table table-bordered bs-table" OnRowDataBound="GVcriterios_RowDataBound" PageSize="40">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cumple">
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="CBcumplio" runat="server" Text="" AutoPostBack="true" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                    ...
                                    <asp:Table ID="Tevaluarcrit2" runat="server" HorizontalAlign="Center">
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Label ID="Lrecomendacion" runat="server" Text="Observaciones:" ForeColor="Black" Font-Bold="True" class="text-justify" ToolTip="Realice los comentarios que considere prudentes y que ayuden a evaluar el trabajo."></asp:Label></asp:TableCell>
                                            <asp:TableCell>
                                                <textarea id="TBbs" runat="server" cssclass="form-control" rows="5" value=""></textarea></asp:TableCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
                                            <asp:TableCell>
                                                <asp:Label ID="Lcalifca" runat="server" Text="Calificación:" ForeColor="Black" Font-Bold="True" class="text-justify"></asp:Label></asp:TableCell>
                                            <asp:TableCell>
