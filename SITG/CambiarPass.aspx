                         ...
                         <div id="Actualizar" runat="server" visible="true" class="row">
                            <asp:Table ID="TableUsuSys" runat="server" HorizontalAlign="Center">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox ID="TBpassactual" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Label ID="Lpassnueva" runat="server" Text="Contraseña Nueva:" ForeColor="Black" Font-Bold="True" class="text-justify"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell>
                                        <asp:Label ID="Lpassnueva2" runat="server" Text="Repetir Contraseña Nueva:" ForeColor="Black" Font-Bold="True" class="text-justify"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>
                                        <asp:TextBox ID="TBpassnueva2" runat="server" TextMode="Password" CssClass="form-control"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </div>
