...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <asp:UpdatePanel ID="UPcatsys" runat="server"> <ContentTemplate>
            <div class="container-fluid">
                <div class="row">
                 ...
                 <div id="Ingreso" runat="server" visible="true" class="row">
                    <asp:Table ID="TableCatSys" runat="server" HorizontalAlign="Center" >
                        <asp:TableRow>
                            <asp:TableCell>
                 ...
                 <div id="Actualizar" runat="server" visible="false" class="row">
                    <asp:Table ID="TableCatSys2" runat="server" HorizontalAlign="Center" >
                        <asp:TableRow>
                            <asp:TableCell>
                         ...
                         <asp:TableRow>
                          ...
                          <asp:TableRow>
                             <asp:TableCell>
                               <asp:Label ID="Licono2" runat="server" Text="ICONO:" ForeColor="Black" Font-Bold="True" ></asp:Label>
                            </asp:TableCell>                         
                            <asp:TableCell ColumnSpan="3">
                                <asp:TextBox ID="TBicono2" runat="server" CssClass="form-control"></asp:TextBox>    
                            </asp:TableCell>                         
                        </asp:TableRow>
                    </asp:Table>                
                </div>
                ...
                <div id="Eliminar" runat="server" visible="false" class="row">
                    <asp:Table ID="TableCatSys3" runat="server" HorizontalAlign="Center" >                
                        <asp:TableRow>
                            <asp:TableCell>
                ...
                <div id="Resultado" runat="server" visible="false" class="row">
                     <asp:GridView ID="gvSysRol" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CATS_ESTADO" HeaderText="ESTADO" />        
                        </Columns>
                     </asp:GridView>
                </div>
                ...
                <div id="Botones" runat="server" class="row" visible="true">
                    <asp:Table ID="Table1" runat="server" HorizontalAlign="Center">
                        <asp:TableRow>
                            <asp:TableCell>
                                <asp:Button ID="LBguardar" runat="server" OnClick="Aceptar" Text="Guardar" class="btn btn-secondary" />
                            </asp:TableCell>
                            <asp:TableCell>
