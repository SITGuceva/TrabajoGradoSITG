...
<asp:Content ID="Asignar_Roles" ContentPlaceHolderID="MainContent" Runat="Server">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="Ingreso" runat="server" visible="true" class="row">
                                        <asp:Table ID="Tasigrol" runat="server" HorizontalAlign="Center">
                                            <asp:TableRow>
                                                <asp:TableCell>
                                                    <asp:Label ID="Lcodigo" runat="server" Text="Código del usuario:" ForeColor="Black" Font-Bold="True" class="text-justify"></asp:Label></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:TextBox ID="TBcodigo" runat="server" TextMode="Number" CssClass="form-control"></asp:TextBox></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:Button ID="Bconsultar" runat="server" OnClick="BuscarUsuario" Text="Consultar" class="btn btn-default" /></asp:TableCell>
                                                <asp:TableCell>
                                                    <asp:Button ID="Bnueva" runat="server" OnClick="Nueva" Text="Nueva Consulta" class="btn btn-default" Visible="false" /></asp:TableCell>
                                            </asp:TableRow>
                                        </asp:Table>
                                    </div>
    ...
    <script type="text/javascript">
          function myconfirmbox() {
              if (confirm("¿Está seguro de asignar el rol?")) {
